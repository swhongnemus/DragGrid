...
class DragFastScroller {
    ...
    public DragFastScroller(Context context, DragAbsListView listView) {
        mList = listView;
        init(context);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        final int y = mThumbY;
        final int viewWidth = mList.getWidth();
        final DragFastScroller.ScrollFade scrollFade = mScrollFade;
    ...
    void onScroll(DragAbsListView view, int firstVisibleItem, int visibleItemCount, 
            int totalItemCount) {
