...
/**
 * <p>This class encapsulates scrolling. You can use scrollers ({@link DragScroller}
...
public class DragScroller  {
     ...
     */
    public DragScroller(Context context, Interpolator interpolator) {
     ...
     */
    public DragScroller(Context context, Interpolator interpolator, boolean flywheel) {
        mFinished = true;
