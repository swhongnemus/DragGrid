...
package net.ronze.widget;

//import static android.widget.AdapterView.SYNC_FIRST_POSITION;
//import static android.widget.AdapterView.SYNC_SELECTED_POSITION;
 ...
 */
public abstract class DragAbsListView extends DragAdapterView<ListAdapter> implements TextWatcher,
     ...
     * Acts upon click
     */
    private DragAbsListView.PerformClick mPerformClick;
     ...
     */
    private DragFastScroller mFastScroller;
     ...
     */
    private DragEdgeEffect mEdgeGlowTop;

    /**
     * Tracks the state of the bottom edge glow.
     */
    private DragEdgeEffect mEdgeGlowBottom;
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(DragAbsListView view, int scrollState);
         ...
         */
        public void onScroll(DragAbsListView view, int firstVisibleItem, int visibleItemCount,
                int totalItemCount);
    }
    ...
    public DragAbsListView(Context context) {
        super(context);
        initAbsListView();
    ...
    public DragAbsListView(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.absListViewStyle);
    }

    public DragAbsListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setOverScrollMode(int mode) {
        if (mode != OVER_SCROLL_NEVER) {
            if (mEdgeGlowTop == null) {
                ...
                mEdgeGlowTop = new DragEdgeEffect(context);
                mEdgeGlowBottom = new DragEdgeEffect(context);
            }
        } else {
            mEdgeGlowTop = null;
    ...
    public void setFastScrollEnabled(boolean enabled) {
        ...
        if (enabled) {
            if (mFastScroller == null) {
                mFastScroller = new DragFastScroller(getContext(), this);
            }
        } else {
            if (mFastScroller != null) {
                mFastScroller.stop();
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DragAbsListView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(DragAbsListView.class.getName());
        if (isEnabled()) {
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link DragAbsListView#onSaveInstanceState()}
         */
    ...
    boolean performLongPress(final View child,
        ...
        if (mOnItemLongClickListener != null) {
            handled = mOnItemLongClickListener.onItemLongClick(DragAbsListView.this, child,
                    longPressPosition, longPressId);
        }
        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            handled = super.showContextMenuForChild(DragAbsListView.this);
        }
        if (handled) {
            performHapticFeedback(HapticFeedbackConstants.LONG_PRESS);
        }
    ...
    public boolean showContextMenu(float x, float y, int metaState) {
        ...
        if (position != INVALID_POSITION) {
            ...
            if (child != null) {
                ...
                return super.showContextMenuForChild(DragAbsListView.this);
            }
        }
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(DragAbsListView.this, originalView,
                        longPressPosition, longPressId);
            }
            if (!handled) {
        ...
        case MotionEvent.ACTION_UP: {
            ...
            case TOUCH_MODE_DONE_WAITING:
                ...
                if (child != null && !child.hasFocusable() && inList) {
                    ...
                    final DragAbsListView.PerformClick performClick = mPerformClick;
     ...
     * {@link net.ronze.widget.DragAbsListView.OnScrollListener}, if any. The state change
    ...
    private class FlingRunnable implements Runnable {
         ...
         */
        private final DragOverScroller mScroller;
        ...
        private final Runnable mCheckFlywheel = new Runnable() {
            public void run() {
                ...
                final DragOverScroller scroller = mScroller;
        ...
        FlingRunnable() {
            mScroller = new DragOverScroller(getContext());
        }
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new DragAbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new DragAbsListView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof DragAbsListView.LayoutParams;
    }
    ...
    public void reclaimViews(List<View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            DragAbsListView.LayoutParams lp = (DragAbsListView.LayoutParams) child.getLayoutParams();
     ...
     *        in the recycler.
     *
     * @see net.ronze.widget.DragAbsListView.RecycleBin
     * @see net.ronze.widget.DragAbsListView.RecyclerListener
     */
    public void setRecyclerListener(RecyclerListener listener) {
        mRecycler.mRecyclerListener = listener;
    }

    class AdapterDataSetObserver extends DragAdapterView<ListAdapter>.AdapterDataSetObserver {
        @Override
    ...
    /**
     * A MultiChoiceModeListener receives events for {@link DragAbsListView#CHOICE_MODE_MULTIPLE_MODAL}.
     ...
     *
     * @see net.ronze.widget.DragAbsListView.RecycleBin
     * @see net.ronze.widget.DragAbsListView#setRecyclerListener(net.ronze.widget.DragAbsListView.RecyclerListener)
     */
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap, int position) {
            DragAbsListView.LayoutParams lp = (DragAbsListView.LayoutParams) scrap.getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    final DragAbsListView.LayoutParams lp
                            = (DragAbsListView.LayoutParams) victim.getLayoutParams();
    ...
    static View retrieveFromScrap(ArrayList<View> scrapViews, int position) {
        ...
        if (size > 0) {
            ...
            for (int i=0; i<size; i++) {
                ...
                if (((DragAbsListView.LayoutParams)view.getLayoutParams())
