...
public class DragGridView extends DragAbsListView {
    /**
     * Disables stretching.
     * 
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (count > 0) {
            ...
            DragAbsListView.LayoutParams p = (DragAbsListView.LayoutParams) child.getLayoutParams();
            if (p == null) {
                p = (DragAbsListView.LayoutParams) generateDefaultLayoutParams();
    ...
    private void setupChild(View child, int position, int y, boolean flow, int childrenLeft,
        ...
        if (recycled && (((DragAbsListView.LayoutParams)child.getLayoutParams()).scrappedFromPosition)
                != position) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DragGridView.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(DragGridView.class.getName());
    }
}
